        ...
        <section id="about" className="py-24 px-6 relative overflow-hidden bg-transparent">
            <div className="max-w-4xl mx-auto">
                <div className="glass-card p-12 md:p-20 relative overflow-hidden">
                    {/* Decorative Blobs */}
                    <div className="absolute -top-24 -right-24 w-64 h-64 bg-emerald-100/30 rounded-full blur-3xl -z-10" />
                    <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-blue-100/30 rounded-full blur-3xl -z-10" />
                    ...
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="text-4xl md:text-5xl font-black tracking-tighter text-black mb-8 leading-[0.9]"
                    >
                        We build robust <br />
                        <span className="text-emerald-700">Systems & UI Web.</span>
                    </motion.h2>
                    ...
                    <div className="grid grid-cols-2 gap-8 pt-8 border-t border-neutral-100">
                        <div>
                            <h4 className="font-black text-xl mb-2">Web Systems</h4>
                        ...
                        <div>
                            <h4 className="font-black text-xl mb-2">UI/UX Design</h4>
